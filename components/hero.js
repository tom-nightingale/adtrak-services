              ...
              <Container>
                <div className="relative z-10 flex flex-wrap justify-center mt-8 lg:mt-20">
                  {heroLinks.map((item, i) => {
                    return(
                      <div className="flex flex-wrap w-full p-4 sm:w-1/2 md:w-1/3" key={i}>
                        <Link href={item.slug} scroll={false}>
                          <a className="flex flex-col justify-center w-full p-4 leading-snug text-center transition-all duration-500 bg-white rounded-2xl lg:text-lg 2xl:p-12 sm:p-8 xl:text-xl font-display text-secondary-dark hover:no-underline hover:text-primary">
